...
int main(int argc, char *argv[])
{
    ...
    Settings_edit_delay(&client_settings, delay);
    Settings_edit(&client_settings, decimation, dec);
    Settings_edit(&client_settings, number_of_bit, bitsize);
    Settings_edit(&client_settings, tgc_start, 0);
    Settings_edit(&client_settings, tgc_end, 255);
    Settings_edit(&client_settings, emulator, 1);
